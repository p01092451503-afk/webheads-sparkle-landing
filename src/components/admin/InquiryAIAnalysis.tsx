    ...
    <div className="mt-4 pt-4 border-t border-[hsl(220,13%,93%)]">
      ...
      {expanded && (
        <div className="bg-white rounded-xl p-5 border border-[hsl(220,13%,93%)] prose prose-sm max-w-none
          ...
          prose-h3:text-[6px] prose-h3:mt-6 prose-h3:mb-2 prose-h3:pb-1.5 prose-h3:border-b prose-h3:border-[hsl(220,13%,93%)]
          prose-p:text-[5px] prose-p:text-foreground/80 prose-p:leading-[1.7] prose-p:my-1
          prose-li:text-[5px] prose-li:text-foreground/80 prose-li:leading-[1.7] prose-li:my-0.5
