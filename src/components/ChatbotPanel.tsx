  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-[520px] md:bottom-[400px] right-3 md:right-5 z-50 w-[52px] h-[52px] rounded-full bg-primary text-primary-foreground shadow-[0_4px_20px_hsl(var(--primary)/0.4)] flex items-center justify-center hover:scale-110 hover:shadow-[0_6px_28px_hsl(var(--primary)/0.5)] transition-all duration-200",
          open && "hidden"
        )}
        aria-label="AI 상담"
      >
