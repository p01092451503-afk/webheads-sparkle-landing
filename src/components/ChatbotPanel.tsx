  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "fixed bottom-[88px] md:bottom-[88px] right-3 md:right-5 z-50 w-14 h-14 rounded-full bg-primary text-primary-foreground shadow-lg flex items-center justify-center hover:scale-110 transition-all duration-200",
          open && "hidden"
        )}
        aria-label="AI 상담"
      >
