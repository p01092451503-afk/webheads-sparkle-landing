          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[1.05rem] font-black text-foreground" style={{ fontFamily: "'Noto Sans', 'Noto Sans KR', sans-serif", fontWeight: 900 }}>신규도입 : 02-336-4338</p>
                <p className="text-[1.05rem] font-black text-foreground" style={{ fontFamily: "'Noto Sans', 'Noto Sans KR', sans-serif", fontWeight: 900 }}>장애 및 유지보수 : 02-540-4337</p>
              </div>
