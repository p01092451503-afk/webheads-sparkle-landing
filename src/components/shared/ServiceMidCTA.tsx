  ...
  return (
    <section className="py-16 bg-primary">
      <div className="container mx-auto px-6 max-w-4xl text-center">
        ...
        <a href={ctaHref} className="inline-flex px-8 py-3.5 rounded-2xl font-bold text-sm bg-background text-foreground hover:bg-background/90 transition-colors">{buttonText}</a>
      </div>
    </section>
  );
}
