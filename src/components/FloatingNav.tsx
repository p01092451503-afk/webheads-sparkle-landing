  ...
  return (
    <div data-floating-nav>
      ...
      <div className="fixed right-5 top-1/2 -translate-y-1/2 z-50 hidden md:flex flex-col gap-2">
        <button onClick={handleCostSimulator} className="group relative w-10 h-10 rounded-full bg-[hsl(var(--lms-primary))] text-white flex items-center justify-center shadow-lg hover:opacity-90 transition-opacity" aria-label={t("floatingNav.costSimulator")}>
