  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center select-none pointer-events-none">
      ...
      <div style={{ width: 420, height: 420, position: "relative", perspective: "900px" }}>
        ...
        {/* ══ Main Card: Maintenance Dashboard ══ */}
        <div style={{
          position: "absolute",
          left: "50%", top: "50%",
          ...
          {/* Service status rows */}
          {[
            { label: "Web Server", status: "정상", bar: 92, color: "#34d399" },
            { label: "Database", status: "정상", bar: 78, color: "#60a5fa" },
            { label: "Security Scan", status: "실행중", bar: 55, color: "#818cf8" },
          ].map((item, i) => (
          ...
          <div style={{ padding: "8px 16px 4px", display: "flex", alignItems: "flex-end", gap: 3, height: 38 }}>
            <span style={{ fontSize: 8, color: "rgba(255,255,255,0.3)", marginRight: 4, alignSelf: "center" }}>응답속도</span>
              ...
              <div
                ...
                style={{
                  ...
                  background: i === 9
                    ...
                    : "rgba(96,165,250,0.3)",
                  animation: `mnt-bar ${1.5 + i * 0.15}s ease-in-out infinite`,
        ...
        {/* ══ Floating Object 1: Wrench / Tool ══ */}
        <div style={{
          position: "absolute", left: "12%", top: "7%",
          animation: "mnt-float-a 3.8s ease-in-out infinite",
          filter: "drop-shadow(0 12px 20px rgba(60,100,220,0.30))",
        }}>
          <svg width="66" height="66" viewBox="0 0 66 66">
            <defs>
              <radialGradient id="wrenchGrad" cx="35%" cy="30%">
                <stop offset="0%" stopColor="hsl(220,75%,72%)" />
                <stop offset="100%" stopColor="hsl(220,75%,42%)" />
              </radialGradient>
            </defs>
        ...
        <div style={{
          ...
          animation: "mnt-float-e 4.2s ease-in-out infinite",
          animationDelay: "0.7s",
          filter: "drop-shadow(0 14px 22px rgba(30,180,100,0.32))",
        }}>
          <svg width="62" height="68" viewBox="0 0 62 68">
            <defs>
              <linearGradient id="mntShieldGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="hsl(152,76%,52%)" />
                <stop offset="100%" stopColor="hsl(152,70%,30%)" />
              </linearGradient>
            </defs>
        ...
        {/* ══ Floating Object 3: Gear / Settings ══ */}
        <div style={{
          position: "absolute", left: "5%", bottom: "16%",
          animation: "mnt-float-c 4.5s ease-in-out infinite",
          animationDelay: "1.2s",
          filter: "drop-shadow(0 16px 24px rgba(130,80,220,0.30))",
        }}>
          <svg width="60" height="60" viewBox="0 0 60 60">
            <defs>
              <linearGradient id="gearGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="hsl(260,70%,68%)" />
                <stop offset="100%" stopColor="hsl(260,70%,42%)" />
              </linearGradient>
            </defs>
            {/* Gear shape */}
            <g transform="translate(30,30)">
              ...
              {/* Animation indicator */}
              <circle r="3" fill="rgba(255,255,255,0.7)" cx="0" cy="-11"
                style={{ animation: "mnt-rotate 3s linear infinite", transformOrigin: "0 0" }} />
            </g>
        ...
        <div style={{
          ...
          animation: "mnt-float-b 3.6s ease-in-out infinite",
          animationDelay: "0.5s",
          background: "linear-gradient(135deg, hsl(220,85%,52%), hsl(220,80%,36%))",
          color: "#fff",
          borderRadius: 10,
          padding: "8px 14px",
          fontWeight: 800, fontSize: 15,
          letterSpacing: -0.5,
          boxShadow: "0 10px 24px rgba(30,60,200,0.38)",
          whiteSpace: "nowrap",
        }}>24/7 <span style={{ fontSize: 9, fontWeight: 500, opacity: 0.8 }}>대응</span></div>

        {/* RCA badge */}
        <div style={{
          position: "absolute", left: "1%", top: "33%",
          animation: "mnt-float-a 4.1s ease-in-out infinite",
          animationDelay: "0.2s",
          background: "linear-gradient(135deg, hsl(35,88%,55%), hsl(25,88%,42%))",
          color: "#fff",
          borderRadius: 10,
          padding: "7px 13px",
          fontWeight: 800, fontSize: 13,
          boxShadow: "0 10px 24px rgba(200,110,30,0.38)",
        }}>RCA</div>

        {/* SLA badge */}
        <div style={{
          position: "absolute", right: "9%", top: "53%",
          animation: "mnt-float-c 4.8s ease-in-out infinite",
          animationDelay: "1s",
          background: "linear-gradient(135deg, hsl(152,70%,38%), hsl(152,78%,26%))",
          color: "#fff",
          borderRadius: 10,
          padding: "7px 13px",
          fontWeight: 800, fontSize: 13,
          boxShadow: "0 10px 24px rgba(30,160,80,0.38)",
          whiteSpace: "nowrap",
        ...
        <div style={{
          ...
          animation: "mnt-float-d 3.4s ease-in-out infinite",
          animationDelay: "0.3s",
          background: "linear-gradient(135deg, hsl(260,72%,58%), hsl(260,78%,40%))",
          color: "#fff",
          borderRadius: 10,
          padding: "7px 13px",
          fontWeight: 800, fontSize: 13,
          boxShadow: "0 10px 24px rgba(120,60,220,0.38)",
        }}>NOC</div>

        {/* 5분 badge */}
        <div style={{
          position: "absolute", left: "18%", bottom: "3%",
          animation: "mnt-float-b 4.3s ease-in-out infinite",
          animationDelay: "0.9s",
          background: "linear-gradient(135deg, hsl(0,68%,54%), hsl(0,76%,38%))",
          color: "#fff",
          borderRadius: 10,
          padding: "6px 12px",
          fontWeight: 800, fontSize: 12,
          boxShadow: "0 8px 20px rgba(180,30,30,0.38)",
          whiteSpace: "nowrap",
        }}>초동 5분</div>
