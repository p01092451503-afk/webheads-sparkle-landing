  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center select-none pointer-events-none">
      ...
      <div style={{ width: 420, height: 420, position: "relative", perspective: "900px" }}>
        ...
        <div style={{ position: "absolute", left: "0%", bottom: "14%", animation: "app-float-c 4.5s ease-in-out infinite", animationDelay: "1.2s", filter: "drop-shadow(0 10px 18px rgba(80,160,220,0.3))" }}>
