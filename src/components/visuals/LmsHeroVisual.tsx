...
export default function LmsHeroVisual() {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center select-none pointer-events-none" style={{ fontFamily: "'Comfortaa', 'Pretendard Variable', 'Pretendard', 'Noto Sans KR', sans-serif" }}>
      <style>{`
