  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center select-none pointer-events-none" style={{ transform: "scale(1.02)", transformOrigin: "center center" }}>
      ...
      <div style={{ width: 340, height: 340, position: "relative", perspective: "900px" }}>
        ...
        <div style={{ position: "absolute", left: "4%", top: "0%", animation: "lms-float-a 3.8s ease-in-out infinite", filter: "drop-shadow(0 12px 20px rgba(120,60,220,0.28))" }}>
        ...
        <div style={{ position: "absolute", right: "0%", top: "2%", animation: "lms-float-e 4.2s ease-in-out infinite", animationDelay: "0.7s", filter: "drop-shadow(0 14px 22px rgba(60,130,220,0.3))" }}>
        ...
        {/* ══ Floating: Book ══ */}
        <div style={{ position: "absolute", left: "-2%", bottom: "10%", animation: "lms-float-c 4.5s ease-in-out infinite", animationDelay: "1.2s", filter: "drop-shadow(0 16px 24px rgba(100,60,200,0.28))" }}>
        ...
        {/* ══ Badges ══ */}
        <div style={{ position: "absolute", right: "-4%", bottom: "18%", animation: "lms-float-b 3.6s ease-in-out infinite", animationDelay: "0.5s", background: "linear-gradient(135deg, hsl(260,80%,60%), hsl(260,70%,42%))", color: "#fff", borderRadius: 10, padding: "8px 14px", fontWeight: 800, fontSize: 14, boxShadow: "0 10px 24px rgba(120,60,220,0.35)", whiteSpace: "nowrap" }}>AI <span style={{ fontSize: 9, fontWeight: 500, opacity: 0.8 }}>Tutor</span></div>
        <div style={{ position: "absolute", left: "-6%", top: "32%", animation: "lms-float-d 4.1s ease-in-out infinite", background: "linear-gradient(135deg, hsl(152,70%,45%), hsl(152,80%,30%))", color: "#fff", borderRadius: 10, padding: "7px 13px", fontWeight: 800, fontSize: 14, boxShadow: "0 10px 24px rgba(30,160,90,0.35)" }}>300+</div>
        <div style={{ position: "absolute", right: "2%", top: "50%", animation: "lms-float-a 4.8s ease-in-out infinite", animationDelay: "1s", background: "linear-gradient(135deg, hsl(35,90%,55%), hsl(25,90%,45%))", color: "#fff", borderRadius: 10, padding: "7px 13px", fontWeight: 800, fontSize: 13, boxShadow: "0 10px 24px rgba(220,120,30,0.35)" }}>{t("visuals.lms.badges.openDays")}</div>
        <div style={{ position: "absolute", left: "20%", top: "-4%", animation: "lms-float-d 3.4s ease-in-out infinite", animationDelay: "0.3s", background: "linear-gradient(135deg, hsl(214,90%,52%), hsl(214,80%,38%))", color: "#fff", borderRadius: 10, padding: "7px 13px", fontWeight: 800, fontSize: 12, boxShadow: "0 10px 24px rgba(30,80,200,0.35)" }}>11 Languages</div>
        <div style={{ position: "absolute", left: "12%", bottom: "-6%", animation: "lms-float-b 4.3s ease-in-out infinite", animationDelay: "0.9s", background: "linear-gradient(135deg, hsl(0,70%,55%), hsl(0,80%,40%))", color: "#fff", borderRadius: 10, padding: "6px 12px", fontWeight: 800, fontSize: 12, boxShadow: "0 8px 20px rgba(180,30,30,0.35)" }}>DRM</div>
      </div>
    </div>
  );
}
