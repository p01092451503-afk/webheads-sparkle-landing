    ...
    <div className="relative w-full h-full flex items-center justify-center select-none pointer-events-none">
      ...
      <div style={{ width: 420, height: 420, position: "relative", perspective: "900px" }}>
        ...
        <div style={{
          ...
          {[
            { label: "UX 디자인 기초", progress: 85, color: "#a78bfa" },
            { label: "Python 데이터 분석", progress: 62, color: "#60a5fa" },
            { label: "비즈니스 영어", progress: 94, color: "#34d399" },
          ].map((course, i) => (
            <div key={i} style={{ padding: "5px 16px", display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{
                ...
                fontSize: 10, fontWeight: 700, color: course.color,
              }}>{i + 1}</div>
              <div style={{ flex: 1 }}>
        ...
        <div style={{
          ...
          animation: "lms-float-a 3.8s ease-in-out infinite",
          filter: "drop-shadow(0 12px 20px rgba(120,60,220,0.28))",
        }}>
          <svg width="68" height="68" viewBox="0 0 68 68">
            <defs>
              <linearGradient id="capGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="hsl(260,80%,65%)" />
                <stop offset="100%" stopColor="hsl(260,80%,40%)" />
              </linearGradient>
            </defs>
        ...
        {/* ══ Floating: Play Button / Video ══ */}
        <div style={{
          position: "absolute", right: "6%", top: "10%",
          animation: "lms-float-e 4.2s ease-in-out infinite",
          animationDelay: "0.7s",
          filter: "drop-shadow(0 14px 22px rgba(60,130,220,0.3))",
        }}>
          <svg width="60" height="60" viewBox="0 0 60 60">
            <defs>
              <linearGradient id="playGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="hsl(214,90%,60%)" />
                <stop offset="100%" stopColor="hsl(214,80%,38%)" />
              </linearGradient>
            </defs>
        ...
        {/* ══ Floating: Book / Content ══ */}
        <div style={{
          position: "absolute", left: "4%", bottom: "16%",
          animation: "lms-float-c 4.5s ease-in-out infinite",
          animationDelay: "1.2s",
          filter: "drop-shadow(0 16px 24px rgba(100,60,200,0.28))",
        }}>
        ...
        <div style={{
          ...
          animation: "lms-float-b 3.6s ease-in-out infinite",
          animationDelay: "0.5s",
          background: "linear-gradient(135deg, hsl(260,80%,60%), hsl(260,70%,42%))",
          color: "#fff",
          borderRadius: 10,
          padding: "8px 14px",
          ...
          whiteSpace: "nowrap",
        }}>AI <span style={{ fontSize: 9, fontWeight: 500, opacity: 0.8 }}>Tutor</span></div>

        {/* 400+ badge */}
        <div style={{
          position: "absolute", left: "2%", top: "36%",
          animation: "lms-float-d 4.1s ease-in-out infinite",
          background: "linear-gradient(135deg, hsl(152,70%,45%), hsl(152,80%,30%))",
          color: "#fff",
          borderRadius: 10,
          padding: "7px 13px",
          fontWeight: 800, fontSize: 14,
        ...
        <div style={{
          ...
          animation: "lms-float-a 4.8s ease-in-out infinite",
          animationDelay: "1s",
        ...
        <div style={{
          ...
          animation: "lms-float-d 3.4s ease-in-out infinite",
          animationDelay: "0.3s",
        ...
        {/* DRM badge */}
        <div style={{
          position: "absolute", left: "18%", bottom: "2%",
          animation: "lms-float-b 4.3s ease-in-out infinite",
          animationDelay: "0.9s",
