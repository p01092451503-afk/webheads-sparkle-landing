  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center select-none pointer-events-none">
      ...
      <div style={{ width: 420, height: 420, position: "relative", perspective: "900px" }}>
        ...
        <div style={{ position: "absolute", left: "2%", top: "36%", animation: "lms-float-d 4.1s ease-in-out infinite", background: "linear-gradient(135deg, hsl(152,70%,45%), hsl(152,80%,30%))", color: "#fff", borderRadius: 10, padding: "7px 13px", fontWeight: 800, fontSize: 14, boxShadow: "0 10px 24px rgba(30,160,90,0.35)" }}>400+</div>
