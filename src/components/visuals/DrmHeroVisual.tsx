  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center select-none pointer-events-none">
      ...
      <div style={{ width: 420, height: 420, position: "relative", perspective: "900px" }}>
        ...
        <div style={{ position: "absolute", left: "4%", top: "4%", animation: "drm-float-a 3.8s ease-in-out infinite", filter: "drop-shadow(0 12px 20px rgba(20,120,70,0.3))" }}>
        ...
        <div style={{ position: "absolute", right: "2%", top: "6%", animation: "drm-float-e 4.2s ease-in-out infinite", animationDelay: "0.7s", filter: "drop-shadow(0 12px 20px rgba(100,50,220,0.3))" }}>
        ...
        {/* ── Floating: Camera off ── */}
        <div style={{ position: "absolute", left: "0%", bottom: "14%", animation: "drm-float-c 4.5s ease-in-out infinite", animationDelay: "1.1s", filter: "drop-shadow(0 10px 18px rgba(220,50,50,0.28))" }}>
        ...
        {/* ── Badges ── */}
        <div style={{ position: "absolute", right: "-2%", bottom: "24%", animation: "drm-float-b 3.6s ease-in-out infinite", animationDelay: "0.5s", background: "linear-gradient(135deg, hsl(152,75%,38%), hsl(152,80%,25%))", color: "#fff", borderRadius: 10, padding: "8px 14px", fontWeight: 800, fontSize: 14, boxShadow: "0 10px 24px rgba(20,120,70,0.38)" }}>AES-128</div>
        <div style={{ position: "absolute", left: "-4%", top: "32%", animation: "drm-float-a 4.1s ease-in-out infinite", background: "linear-gradient(135deg, hsl(280,75%,58%), hsl(280,80%,40%))", color: "#fff", borderRadius: 10, padding: "7px 13px", fontWeight: 800, fontSize: 13, boxShadow: "0 10px 24px rgba(140,50,220,0.35)" }}>Widevine</div>
        <div style={{ position: "absolute", right: "4%", top: "52%", animation: "drm-float-c 4.8s ease-in-out infinite", animationDelay: "1s", background: "linear-gradient(135deg, hsl(35,90%,55%), hsl(25,90%,45%))", color: "#fff", borderRadius: 10, padding: "7px 13px", fontWeight: 800, fontSize: 13, boxShadow: "0 10px 24px rgba(220,120,30,0.35)" }}>{t("visuals.drm.badges.block")}</div>
        <div style={{ position: "absolute", left: "22%", top: "-2%", animation: "drm-float-e 3.4s ease-in-out infinite", animationDelay: "0.3s", background: "linear-gradient(135deg, hsl(214,80%,52%), hsl(214,80%,35%))", color: "#fff", borderRadius: 10, padding: "7px 12px", fontWeight: 800, fontSize: 12, boxShadow: "0 10px 24px rgba(30,80,200,0.35)" }}>FairPlay</div>
        <div style={{ position: "absolute", left: "14%", bottom: "-2%", animation: "drm-float-b 4.3s ease-in-out infinite", animationDelay: "0.9s", background: "linear-gradient(135deg, hsl(0,70%,55%), hsl(0,80%,40%))", color: "#fff", borderRadius: 10, padding: "6px 12px", fontWeight: 800, fontSize: 12, boxShadow: "0 8px 20px rgba(180,30,30,0.35)" }}>{t("visuals.drm.badges.watermark")}</div>
      </div>
    </div>
  );
}
