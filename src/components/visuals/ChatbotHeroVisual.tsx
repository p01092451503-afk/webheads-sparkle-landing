    ...
    <div className="relative w-full h-full flex items-center justify-center select-none pointer-events-none">
      ...
      <div style={{ width: 420, height: 420, position: "relative", perspective: "900px" }}>
        ...
        <div style={{
          ...
          width: 250, height: 210, borderRadius: 22,
          ...
          <div style={{ padding: "12px 14px 8px", display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid rgba(255,255,255,0.07)" }}>
            ...
            <div>
              <div style={{ fontSize: 9, color: "#fff", fontWeight: 700 }}>{t("visuals.chatbot.botName")}</div>
              <div style={{ fontSize: 7, color: "hsl(192,80%,55%)" }}>{t("visuals.chatbot.responding")}</div>
            </div>
          ...
          <div style={{ padding: "10px 12px", display: "flex", flexDirection: "column", gap: 7 }}>
            <div style={{ alignSelf: "flex-end", background: "hsl(192,70%,38%)", borderRadius: "12px 12px 3px 12px", padding: "6px 10px", maxWidth: "75%" }}>
              <p style={{ fontSize: 8, color: "#fff", lineHeight: 1.4 }}>{t("visuals.chatbot.userMsg1")}</p>
            </div>
            <div style={{ alignSelf: "flex-start", background: "rgba(255,255,255,0.08)", borderRadius: "12px 12px 12px 3px", padding: "6px 10px", maxWidth: "85%", animation: "cb-appear 0.5s ease-out" }}>
              <p style={{ fontSize: 8, color: "rgba(255,255,255,0.85)", lineHeight: 1.5 }} dangerouslySetInnerHTML={{ __html: t("visuals.chatbot.botMsg1") }} />
            </div>
            <div style={{ alignSelf: "flex-end", background: "hsl(192,70%,38%)", borderRadius: "12px 12px 3px 12px", padding: "6px 10px", maxWidth: "65%" }}>
              <p style={{ fontSize: 8, color: "#fff", lineHeight: 1.4 }}>{t("visuals.chatbot.userMsg2")}</p>
            </div>
          ...
          <div style={{ position: "absolute", bottom: 8, left: 10, right: 10, background: "rgba(255,255,255,0.07)", borderRadius: 12, padding: "6px 10px", display: "flex", alignItems: "center", gap: 6, border: "1px solid rgba(255,255,255,0.1)" }}>
            <span style={{ fontSize: 7, color: "rgba(255,255,255,0.25)", flex: 1 }}>{t("visuals.chatbot.inputPlaceholder")}</span>
        ...
        <div style={{ position: "absolute", left: "4%", top: "4%", animation: "cb-float-a 3.8s ease-in-out infinite", filter: "drop-shadow(0 12px 20px rgba(20,140,160,0.3))" }}>
        ...
        <div style={{ position: "absolute", right: "2%", top: "6%", animation: "cb-float-e 4.2s ease-in-out infinite", animationDelay: "0.7s", filter: "drop-shadow(0 12px 20px rgba(130,50,220,0.3))" }}>
        ...
        <div style={{ position: "absolute", left: "0%", bottom: "14%", animation: "cb-float-c 4.5s ease-in-out infinite", animationDelay: "1.1s", filter: "drop-shadow(0 10px 18px rgba(250,160,30,0.3))" }}>
        ...
        {/* ── Badges ── */}
        <div style={{ position: "absolute", right: "-2%", bottom: "24%", animation: "cb-float-b 3.6s ease-in-out infinite", animationDelay: "0.5s", background: "linear-gradient(135deg, hsl(192,80%,42%), hsl(192,70%,28%))", color: "#fff", borderRadius: 10, padding: "8px 14px", fontWeight: 800, fontSize: 14, boxShadow: "0 10px 24px rgba(20,140,160,0.38)", whiteSpace: "nowrap" }}>GPT-4o</div>
        <div style={{ position: "absolute", left: "-4%", top: "32%", animation: "cb-float-a 4.1s ease-in-out infinite", background: "linear-gradient(135deg, hsl(280,75%,58%), hsl(280,80%,40%))", color: "#fff", borderRadius: 10, padding: "7px 13px", fontWeight: 800, fontSize: 13, boxShadow: "0 10px 24px rgba(140,50,220,0.35)" }}>RAG</div>
        <div style={{ position: "absolute", right: "4%", top: "52%", animation: "cb-float-c 4.8s ease-in-out infinite", animationDelay: "1s", background: "linear-gradient(135deg, hsl(35,90%,55%), hsl(25,90%,45%))", color: "#fff", borderRadius: 10, padding: "7px 13px", fontWeight: 800, fontSize: 13, boxShadow: "0 10px 24px rgba(220,120,30,0.35)" }}>24/7</div>
        <div style={{ position: "absolute", left: "22%", top: "-2%", animation: "cb-float-e 3.4s ease-in-out infinite", animationDelay: "0.3s", background: "linear-gradient(135deg, hsl(152,70%,40%), hsl(152,80%,28%))", color: "#fff", borderRadius: 10, padding: "7px 12px", fontWeight: 800, fontSize: 12, boxShadow: "0 10px 24px rgba(30,160,90,0.35)" }}>{t("visuals.chatbot.badges.multilang")}</div>
        <div style={{ position: "absolute", left: "14%", bottom: "-2%", animation: "cb-float-b 4.3s ease-in-out infinite", animationDelay: "0.9s", background: "linear-gradient(135deg, hsl(0,70%,55%), hsl(0,80%,40%))", color: "#fff", borderRadius: 10, padding: "6px 12px", fontWeight: 800, fontSize: 12, boxShadow: "0 8px 20px rgba(180,30,30,0.35)" }}>{t("visuals.chatbot.badges.autoRate")}</div>
      </div>
    </div>
  );
}
