  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center select-none pointer-events-none">
      ...
      <div style={{ width: 420, height: 420, position: "relative", perspective: "900px" }}>
        ...
        {/* ── Floating: Bell icon ── */}
        <div style={{ position: "absolute", left: "4%", top: "4%", animation: "ch-float-a 3.8s ease-in-out infinite", filter: "drop-shadow(0 12px 20px rgba(200,120,20,0.3))" }}>
        ...
        <div style={{ position: "absolute", right: "2%", top: "6%", animation: "ch-float-e 4.2s ease-in-out infinite", animationDelay: "0.7s", filter: "drop-shadow(0 12px 20px rgba(250,200,10,0.3))" }}>
        ...
        {/* ── Floating: SMS phone ── */}
        <div style={{ position: "absolute", left: "0%", bottom: "14%", animation: "ch-float-c 4.5s ease-in-out infinite", animationDelay: "1.1s", filter: "drop-shadow(0 10px 18px rgba(30,100,220,0.28))" }}>
