...
export default function Header() {
  ...
  const isLightPage = location.pathname === "/service-request" || location.pathname === "/overview" || location.pathname === "/blog" || location.pathname.startsWith("/blog/") || location.pathname === "/event";
  ...
  return (
    <>
      ...
      {(isKorean && !bannerDismissed && new Date() <= new Date("2026-03-31T23:59:59+09:00")) && (
        ...
        >
          <div className="container mx-auto pl-3 sm:pl-4 pr-10 sm:pr-12 max-w-7xl flex items-center justify-center gap-2 sm:gap-3 py-2.5 relative z-10">
