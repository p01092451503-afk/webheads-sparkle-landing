...
export default function Header() {
  ...
  const isLightPage = location.pathname === "/service-request" || location.pathname === "/" || location.pathname === "/blog" || location.pathname.startsWith("/blog/") || location.pathname === "/event";
