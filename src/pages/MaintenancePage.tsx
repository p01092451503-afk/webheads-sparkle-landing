  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none" style={{ opacity: 0.05, backgroundImage: "linear-gradient(45deg, hsl(210, 30%, 45%) 25%, transparent 25%), linear-gradient(-45deg, hsl(210, 30%, 45%) 25%, transparent 25%), linear-gradient(45deg, transparent 75%, hsl(210, 30%, 45%) 75%), linear-gradient(-45deg, transparent 75%, hsl(210, 30%, 45%) 75%)", backgroundSize: "20px 20px", backgroundPosition: "0 0, 0 10px, 10px -10px, -10px 0" }} />
