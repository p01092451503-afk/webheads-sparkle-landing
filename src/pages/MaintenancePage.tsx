      ...
      <section id="plans" className="py-28" style={{ background: "var(--plans-bg)" }}>
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="mt-12 text-center rounded-2xl border border-border bg-secondary/50 p-8">
            ...
            <a href="#contact" className="inline-flex px-8 py-3.5 rounded-2xl font-bold text-sm bg-primary text-primary-foreground hover:bg-primary/90 transition-colors">{t("maintenance.plansCustom.cta")}</a>
          </div>
        </div>
      </section>
