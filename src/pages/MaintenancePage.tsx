  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-none" style={{ opacity: 0.025, backgroundImage: "linear-gradient(45deg, hsl(210, 30%, 45%) 25%, transparent 25%), linear-gradient(-45deg, hsl(210, 30%, 45%) 25%, transparent 25%), linear-gradient(45deg, transparent 75%, hsl(210, 30%, 45%) 75%), linear-gradient(-45deg, transparent 75%, hsl(210, 30%, 45%) 75%)", backgroundSize: "20px 20px", backgroundPosition: "0 0, 0 10px, 10px -10px, -10px 0" }} />
        <div className="absolute pointer-events-none" style={{ width: "120%", height: "120%", top: "-10%", left: "-10%", background: "radial-gradient(ellipse 60% 50% at 65% 45%, hsl(210, 50%, 55%, 0.16) 0%, transparent 70%)" }} />
        <div className="absolute pointer-events-none" style={{ width: "80%", height: "80%", bottom: "-10%", left: "-5%", background: "radial-gradient(ellipse 50% 60% at 30% 70%, hsl(215, 40%, 50%, 0.08) 0%, transparent 70%)" }} />
