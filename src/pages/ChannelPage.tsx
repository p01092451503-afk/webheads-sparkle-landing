    ...
    <div className="min-h-screen bg-background">
      ...
      >
        <div className="absolute right-0 top-0 h-full w-[55%] pointer-events-none select-none hidden lg:block">
          <img src={heroChannel} alt="" fetchPriority="high" className="absolute left-[5%] top-1/2 -translate-y-1/2 w-[65%] object-contain animate-float" style={{ filter: "drop-shadow(0 40px 80px rgba(30,60,120,0.22)) drop-shadow(0 12px 28px rgba(30,60,120,0.14))" }} />
        </div>
