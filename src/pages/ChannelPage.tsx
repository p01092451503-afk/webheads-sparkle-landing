  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[76vh] flex items-center pt-20 pb-14 overflow-hidden" style={{ background: "var(--channel-hero-bg)" }}>
        ...
        <div className="absolute inset-0 pointer-events-none" style={{ opacity: 0.07, backgroundImage: "repeating-linear-gradient(135deg, hsl(155, 50%, 35%) 0px, hsl(155, 50%, 35%) 1px, transparent 1px, transparent 12px)", backgroundSize: "17px 17px" }} />
