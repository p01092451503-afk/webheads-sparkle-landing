  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="hero-section min-h-[70vh] flex items-center pt-20">
        <img src={heroChannel} alt="" fetchPriority="high" className="absolute inset-0 w-full h-full object-cover opacity-20 pointer-events-none" />
        <div className="container mx-auto px-4 py-20 relative">
          <div className="max-w-2xl">
            <span className="feature-badge mb-5" style={{ background: "hsl(40 90% 55% / 0.15)", color: "hsl(40 90% 70%)", borderColor: "hsl(40 90% 55% / 0.3)" }}>채널톡 / SMS</span>
            <h1 className="text-4xl lg:text-5xl font-bold text-white mt-4 mb-5 leading-tight">
              학습자와의 소통을<br />
              <span className="text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg, hsl(40,90%,65%), hsl(25,90%,65%))" }}>자동화로 효율화</span>
            </h1>
            <p className="text-white/60 text-lg leading-relaxed mb-8 max-w-xl">채널톡과 SMS를 LMS와 연동하여 학습 독려부터 수료 안내까지 학습자와의 모든 커뮤니케이션을 자동화하세요.</p>
            <div className="flex gap-3">
              <a href="#contact" className="btn-primary px-7 py-3.5 rounded-xl font-semibold">도입 상담 신청</a>
              <a href="#usecases" className="px-7 py-3.5 rounded-xl font-semibold border border-white/20 text-white hover:bg-white/10 transition-colors">활용 사례 보기</a>
            </div>
          </div>
        </div>
      </section>
