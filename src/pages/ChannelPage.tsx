  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        ...
        style={{ background: "linear-gradient(135deg, hsl(40, 60%, 98%) 0%, hsl(30, 40%, 96%) 100%)" }}
      >
        <div
        ...
        >
          <img src={heroChannel} alt="" fetchPriority="high" className="absolute left-[-10%] top-1/2 -translate-y-1/2 w-[100%] object-contain" style={{ mixBlendMode: "multiply" }} />
        </div>
