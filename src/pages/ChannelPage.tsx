...
export default function ChannelPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO title={t("channel.seo.title")} description={t("channel.seo.description")} keywords={t("channel.seo.keywords")} path="/channel" breadcrumb={[{ name: t("channel.seo.title"), url: `${BASE_URL}/channel` }]} jsonLd={{ "@context": "https://schema.org", "@type": "Service", "name": `${t("channel.seo.title")} - Webheads`, "provider": { "@type": "Organization", "name": "Webheads (웹헤즈)" }, "description": t("channel.seo.description"), "areaServed": "KR", "serviceType": t("channel.seo.title"), <SEO title={t("channel.seo.title")} description={t("channel.seo.description")} keywords={t("channel.seo.keywords")} path="/channel" breadcrumb={[{ name: t("channel.seo.title"), url: `${BASE_URL}/channel` }]} jsonLd={{ "@context": "https://schema.org", "@type": "Service", "name": `${t("channel.seo.title")} - Webheads`, "provider": { "@type": "Organization", "name": "Webheads (웹헤즈)" }, "description": t("channel.seo.description"), "areaServed": "KR", "serviceType": t("channel.seo.title"), "url": `${BASE_URL}/channel`, "additionalProperty": { "@type": "PropertyValue", "name": "clientCount", "value": "300" } }} faqJsonLd={faqs} />={t("channel.seo.title")} description={t("channel.seo.description")} keywords={t("channel.seo.keywords")} path="/channel" breadcrumb={[{ name: t("channel.seo.title"), url: `${BASE_URL}/channel` }]} jsonLd={{ "@context": "https://schema.org", "@type": "Service", "name": `${t("channel.seo.title")} - Webheads`, "provider": { "@type": "Organization", "name": "Webheads (웹헤즈)" }, "description": t("channel.seo.description"), "areaServed": "KR", "serviceType": t("channel.seo.title"), "url": `${BASE_URL}/channel`, "additionalProperty": { "@type": "PropertyValue", "name": "clientCount", "value": "300" } }} faqJsonLd={faqs} /> faqJsonLd={faqs} />
      ...
      {/* Process - W */}
      <ServiceProcess bg="bg-background" steps={processSteps} heading={t("channel.processSection.title")} subheading={t("channel.processSection.sub")} description={t("channel.processSection.desc")} />

      {/* Testimonials - G */}
      <TestimonialSection bg="bg-secondary" testimonials={testimonials} />

      {/* FAQ - W */}
      <ServiceFAQ bg="bg-background" faqs={faqs} serviceName={t("channel.seo.title")} />
