  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[76vh] flex items-center pt-20 pb-14 overflow-hidden" style={{ background: "var(--appdev-hero-bg)" }}>
        {/* Crosshatch pattern */}
        <div className="absolute inset-0 pointer-events-none" style={{ opacity: 0.03, backgroundImage: "linear-gradient(45deg, hsl(170, 50%, 35%) 1px, transparent 1px), linear-gradient(-45deg, hsl(170, 50%, 35%) 1px, transparent 1px)", backgroundSize: "24px 24px" }} />
