...
export default function AppDevPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <section className="relative flex items-center pt-20 pb-6 overflow-hidden" style={{ background: "var(--appdev-hero-bg)" }}>
        ...
        <div className="absolute inset-0 pointer-events-none select-none flex items-center justify-center" style={{ opacity: 0.85 }}>
          <div className="relative w-full h-full max-w-[765px] mx-auto hidden lg:flex items-center justify-center" style={{ transform: "translateX(40%) translateY(8%)" }}><AppDevHeroVisual /></div>
        </div>
        <div className="container mx-auto px-6 py-14 relative z-10 lg:pl-[10%]">
          <div className="max-w-xl">
            ...
            <div className="flex gap-3 flex-wrap">
              <a href="#contact" className="px-5 py-2.5 rounded-2xl font-bold text-sm transition-opacity hover:opacity-85 bg-foreground text-background">{t("appdev.hero.cta1")}</a>
              <a href="#other" className="px-5 py-2.5 rounded-2xl font-bold text-sm transition-colors border border-border text-foreground bg-background/80 dark:bg-muted/80 backdrop-blur-sm">{t("appdev.hero.cta2")}</a>
            </div>
          </div>
        </div>
      </section>
