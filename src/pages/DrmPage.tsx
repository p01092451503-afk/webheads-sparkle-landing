...
const testimonials = [
  ...
  { name: "조은비", role: "운영 디렉터", org: "H 사이버대학교", rating: 3, date: "2024.11", period: "이용 2년차", content: "학습자분들이 예전에는 플러그인 설치하라고 하면 불만이 많았는데, 지금은 그냥 브라우저에서 바로 재생돼서 민원이 거의 없어졌어요. LMS 연동도 깔끔합니다." },
