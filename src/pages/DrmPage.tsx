...
export default function DrmPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO title={t("drm.seo.title")} description={t("drm.seo.description")} keywords={t("drm.seo.keywords")} path="/drm" breadcrumb={[{ name: t("drm.seo.title"), url: `${BASE_URL}/drm` }]} jsonLd={{ "@context": "https://schema.org", "@type": "Service", "name": `${t("drm.seo.title")} - Webheads`, "provider": { "@type": "Organization", "name": "Webheads (웹헤즈)" }, "description": t("drm.seo.description"), "areaServed": "KR", "serviceType": t("drm.seo.title"), <SEO title={t("drm.seo.title")} description={t("drm.seo.description")} keywords={t("drm.seo.keywords")} path="/drm" breadcrumb={[{ name: t("drm.seo.title"), url: `${BASE_URL}/drm` }]} jsonLd={{ "@context": "https://schema.org", "@type": "Service", "name": `${t("drm.seo.title")} - Webheads`, "provider": { "@type": "Organization", "name": "Webheads (웹헤즈)" }, "description": t("drm.seo.description"), "areaServed": "KR", "serviceType": t("drm.seo.title"), "url": `${BASE_URL}/drm`, "additionalProperty": { "@type": "PropertyValue", "name": "clientCount", "value": "300" } }} faqJsonLd={faqs} howToJsonLd={{ name: "DRM 솔루션 도입 절차", description: "교육 콘텐츠 보호를 위한 DRM 솔루션을 도입하는 단계별 프로세스입니다.", steps: [{ name: "콘텐츠 분석", text: "보호 대상 콘텐츠 유형, 포맷, 배포 채널을 분석합니다." }, { name: "DRM 설계", text: "Widevine, FairPlay, PlayReady 등 적합한 DRM 조합을 설계합니다." }, { name: "적용 및 인코딩", text: "기존 콘텐츠에 DRM을 적용하고 인코딩 파이프라인을 구축합니다." }, { name: "테스트 및 배포", text: "멀티 디바이스 호환성 테스트 후 운영 환경에 배포합니다." }] }} />={t("drm.seo.title")} description={t("drm.seo.description")} keywords={t("drm.seo.keywords")} path="/drm" breadcrumb={[{ name: t("drm.seo.title"), url: `${BASE_URL}/drm` }]} jsonLd={{ "@context": "https://schema.org", "@type": "Service", "name": `${t("drm.seo.title")} - Webheads`, "provider": { "@type": "Organization", "name": "Webheads (웹헤즈)" }, "description": t("drm.seo.description"), "areaServed": "KR", "serviceType": t("drm.seo.title"), "url": `${BASE_URL}/drm`, "additionalProperty": { "@type": "PropertyValue", "name": "clientCount", "value": "300" } }} faqJsonLd={faqs} howToJsonLd={{ name: "DRM 솔루션 도입 절차", description: "교육 콘텐츠 보호를 위한 DRM 솔루션을 도입하는 단계별 프로세스입니다.", steps: [{ name: "콘텐츠 분석", text: "보호 대상 콘텐츠 유형, 포맷, 배포 채널을 분석합니다." }, { name: "DRM 설계", text: "Widevine, FairPlay, PlayReady 등 적합한 DRM 조합을 설계합니다." }, { name: "적용 및 인코딩", text: "기존 콘텐츠에 DRM을 적용하고 인코딩 파이프라인을 구축합니다." }, { name: "테스트 및 배포", text: "멀티 디바이스 호환성 테스트 후 운영 환경에 배포합니다." }] }} /> faqJsonLd={faqs} howToJsonLd={{ name: "DRM 솔루션 도입 절차", description: "교육 콘텐츠 보호를 위한 DRM 솔루션을 도입하는 단계별 프로세스입니다.", steps: [{ name: "콘텐츠 분석", text: "보호 대상 콘텐츠 유형, 포맷, 배포 채널을 분석합니다." }, { name: "DRM 설계", text: "Widevine, FairPlay, PlayReady 등 적합한 DRM 조합을 설계합니다." }, { name: "적용 및 인코딩", text: "기존 콘텐츠에 DRM을 적용하고 인코딩 파이프라인을 구축합니다." }, { name: "테스트 및 배포", text: "멀티 디바이스 호환성 테스트 후 운영 환경에 배포합니다." }] }} />
