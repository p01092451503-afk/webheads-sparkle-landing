      ...
      <section className="py-28 bg-background">
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="rounded-3xl bg-foreground p-12 md:p-16 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              <h2 className="font-black text-primary-foreground leading-tight mb-3 text-3xl lg:text-4xl tracking-tight">결제 연동을 지금 시작하세요</h2>
              <p className="text-white/40 text-base leading-relaxed max-w-md">웹헤즈 결제 전문팀이 이러닝 플랫폼에 최적화된 PG 연동 방안을 제안해 드립니다.</p>
            </div>
