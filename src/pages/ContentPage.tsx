...
export default function ContentPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO title={t("content.seo.title")} description={t("content.seo.description")} keywords={t("content.seo.keywords")} path="/content" breadcrumb={[{ name: t("content.seo.title"), url: `${BASE_URL}/content` }]} jsonLd={{ "@context": "https://schema.org", "@type": "Service", "name": `${t("content.seo.title")} - Webheads`, "provider": { "@type": "Organization", "name": "Webheads (웹헤즈)" }, "description": t("content.seo.description"), "areaServed": "KR", "serviceType": t("content.seo.title"), <SEO title={t("content.seo.title")} description={t("content.seo.description")} keywords={t("content.seo.keywords")} path="/content" breadcrumb={[{ name: t("content.seo.title"), url: `${BASE_URL}/content` }]} jsonLd={{ "@context": "https://schema.org", "@type": "Service", "name": `${t("content.seo.title")} - Webheads`, "provider": { "@type": "Organization", "name": "Webheads (웹헤즈)" }, "description": t("content.seo.description"), "areaServed": "KR", "serviceType": t("content.seo.title"), "url": `${BASE_URL}/content`, "additionalProperty": { "@type": "PropertyValue", "name": "clientCount", "value": "300" } }} faqJsonLd={faqs} />={t("content.seo.title")} description={t("content.seo.description")} keywords={t("content.seo.keywords")} path="/content" breadcrumb={[{ name: t("content.seo.title"), url: `${BASE_URL}/content` }]} jsonLd={{ "@context": "https://schema.org", "@type": "Service", "name": `${t("content.seo.title")} - Webheads`, "provider": { "@type": "Organization", "name": "Webheads (웹헤즈)" }, "description": t("content.seo.description"), "areaServed": "KR", "serviceType": t("content.seo.title"), "url": `${BASE_URL}/content`, "additionalProperty": { "@type": "PropertyValue", "name": "clientCount", "value": "300" } }} faqJsonLd={faqs} /> faqJsonLd={faqs} />
      ...
      {/* MidCTA - Blue (between features and content types) */}
      ...
      {/* Process - W */}
      <ServiceProcess bg="bg-background" steps={processSteps} heading={t("content.processSection.title")} subheading={t("content.processSection.sub")} description={t("content.processSection.desc")} />

      {/* Testimonials - G */}
      <TestimonialSection bg="bg-secondary" testimonials={testimonials} />

      {/* FAQ - W */}
      <ServiceFAQ bg="bg-background" faqs={faqs} serviceName={t("content.seo.title")} />
