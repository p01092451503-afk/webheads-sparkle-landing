...
import {
  ...
  Building2, Code, Monitor, Cpu, BriefcaseBusiness, UserCheck, Layers
} from "lucide-react";
      ...
      <section data-pdf-section id="contact" className="py-16">
        <div className="container mx-auto px-6 max-w-2xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="tel:02-540-4337" className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full font-bold text-sm transition-all border-2 hover:opacity-90 whitespace-nowrap" style={{ borderColor: "hsl(255,75%,58%)", color: "hsl(255,75%,58%)" }}>
              <Phone className="w-4 h-4 shrink-0" />
              {t("overview.cta.phone2")}
            </a>
            <Link to="/lms#contact" className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-full font-bold text-sm transition-all border-2 hover:opacity-90 whitespace-nowrap" style={{ borderColor: "hsl(255,75%,58%)", color: "hsl(255,75%,58%)" }}>
