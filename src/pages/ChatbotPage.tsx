  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[76vh] flex items-center pt-20 pb-14 overflow-hidden" style={{ background: "var(--chatbot-hero-bg)" }}>
        ...
        <div className="absolute inset-0 pointer-events-none" style={{ opacity: 0.03, backgroundImage: "radial-gradient(circle 2px, hsl(190, 55%, 38%) 1px, transparent 2px)", backgroundSize: "28px 16px", backgroundPosition: "0 0, 14px 8px" }} />
        ...
        <div className="container mx-auto px-6 py-24 relative z-10 lg:pl-[10%]">
          <div className="max-w-xl">
            ...
            <h1 className="text-4xl lg:text-[3.2rem] font-black leading-tight mb-5 tracking-tight text-foreground">{t("chatbot.hero.title")}<br /><span style={{ color: "hsl(200, 80%, 38%)" }}>{t("chatbot.hero.titleHighlight")}</span></h1>
