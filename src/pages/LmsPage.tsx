...
export default function LmsPage() {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--lms-page-bg)", fontFamily: "'Wanted Sans Variable', 'Wanted Sans', 'Pretendard Variable', 'Pretendard', 'Noto Sans KR', sans-serif" }}>
      <SEO
