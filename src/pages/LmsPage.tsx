      ...
      <section className="relative flex items-center justify-center pt-28 pb-28 md:pt-44 md:pb-44 overflow-hidden">
        ...
        <div className="container mx-auto px-5 md:px-6 relative z-10 text-center flex flex-col items-center">
          ...
          <div className="flex gap-3 md:gap-4 flex-wrap justify-center">
            ...
            <a href="#cost-simulator" className="px-7 py-3.5 rounded-xl font-bold text-base transition-all hover:scale-[1.03] flex items-center gap-2 text-white" style={{ background: "linear-gradient(135deg, hsl(145, 80%, 42%), hsl(160, 85%, 38%))", boxShadow: "0 8px 30px rgba(0,0,0,0.15)" }}>
