  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[76vh] flex items-center pt-20 pb-14 overflow-hidden" style={{ background: "var(--hosting-hero-bg)" }}>
        {/* Scanline pattern */}
        <div className="absolute inset-0 pointer-events-none" style={{ opacity: 0.035, backgroundImage: "repeating-linear-gradient(0deg, hsl(200, 60%, 35%) 0px, hsl(200, 60%, 35%) 1px, transparent 1px, transparent 8px)", backgroundSize: "100% 8px" }} />
