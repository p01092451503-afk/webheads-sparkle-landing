...
## 분석 지침
고객 문의를 다음 구조로 분석해주세요:

### 1. 📋 요구사항 분석
고객이 요청한 기능/요구사항을 항목별로 정리

### 2. ✅ 웹헤즈 솔루션으로 가능한 기능
기본 제공 또는 기존 기능으로 충족 가능한 항목

### 3. 🔧 커스터마이징 필요 기능
기본 기능에 포함되지 않지만 커스터마이징으로 구현 가능한 항목 (대략적 추가 비용 포함)

### 4. ❌ 불가능하거나 제한적인 기능
현재 솔루션으로 구현이 어렵거나 제한적인 항목 (대안 제시)

### 5. 💰 추천 요금제 및 예상 비용
- 추천 플랜과 그 이유
- 월 기본료
- 예상 추가 비용 (커스터마이징, 추가 용량 등)
- 총 예상 월 비용 범위

### 6. 📝 제안 전략 요약
영업 시 강조할 포인트, 경쟁 우위, 주의사항

마크다운 형식으로 깔끔하게 작성해주세요. 구체적인 숫자와 금액을 포함해주세요.`;
